...
from utils import DynamicModel, RelationData, RelationSentence, formatting_fix
from discriminate.test import predict
import json
        ...
        while len(sents) < num:
            ...
            for o in outputs:                
                ...
                try:
                    ...
                    index_cont = y.lower().index(context_str.lower())      
                    index_head = y.lower().index(head_str.lower())      
                    index_tail = y.lower().index(tail_str.lower())
                ...
                try:
                    ...
                    if type(s) == str:
                        ...
                        str_s = ' '.join(s.tokens[:-1])
                        dis_res =  str(predict(str_s))
